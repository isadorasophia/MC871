...
exe         = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/prog/mip"
model_name  = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/data/input/skull.scn"

output   = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/data/output/mip.ppm"

def change():
    try:
        res = subprocess.check_call([exe, model_name, output, str(w1.get()), \
                                    str(w2.get()), str(w3.get())])
