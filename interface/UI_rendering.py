...
model_name  = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/data/input/skull.scn"
labels_name = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/data/input/skull.scn"

output   = "/home/bonnibel/graduation/6thsemester/mo815/libmc920/data/output/rendering.ppm"

def change():
    try:
        res = subprocess.check_call([exe, model_name, labels_name, output, 
                                     str(w1.get()), str(w2.get()), str(w3.get()), 
                                     "NORMAL"])
...
root = Tk()
root.title("Rendering Simulator")
